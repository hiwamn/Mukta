...
namespace Infrastructure.EndPoint.Migrations
{
    ...
    [Migration("20200405114028_170102")]
    partial class _170102
    {
            ...
            modelBuilder.Entity("Core.Entities.StoreCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a175c499-2a83-4140-80b8-d29789a5ea71"),
                            CreatedAt = 0L,
                            Name = "Cooktop"
                        },
                        new
                        {
                            Id = new Guid("c02aaa50-ecc8-4c39-8c89-65502b135e67"),
                            CreatedAt = 0L,
                            Name = "Cooking range"
                        },
                        new
                        {
                            Id = new Guid("7f1d3829-c9e7-4dea-beb0-03614a705e51"),
                            CreatedAt = 0L,
                            Name = "Chimney"
                        },
                        new
                        {
                            Id = new Guid("d6d91602-78c5-4860-a240-e1fe8dc53eee"),
                            CreatedAt = 0L,
                            Name = "Hobs"
                        },
                        new
                        {
                            Id = new Guid("cf6395f1-c917-418e-8c9d-eaee21ef1935"),
                            CreatedAt = 0L,
                            Name = "Cookware"
                        },
                        new
                        {
                            Id = new Guid("6d0a9e60-f029-4cb0-bc4e-907ce0198c42"),
                            CreatedAt = 0L,
                            Name = "Cooker"
                        });
                });
