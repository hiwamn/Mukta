...
namespace Infrastructure.EndPoint.Migrations
{
    ...
    [Migration("20200403111507_150101")]
    partial class _150101
    {
            ...
            modelBuilder.Entity("Core.Entities.StoreCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a62b7773-b704-4522-905b-e670351e235f"),
                            CreatedAt = 0L,
                            Name = "Cooktop"
                        },
                        new
                        {
                            Id = new Guid("17fc9e20-f4f9-4136-8e62-41fc46adb941"),
                            CreatedAt = 0L,
                            Name = "Cooking range"
                        },
                        new
                        {
                            Id = new Guid("61eeb02b-6e25-49e9-a4e9-7a138d8f9381"),
                            CreatedAt = 0L,
                            Name = "Chimney"
                        },
                        new
                        {
                            Id = new Guid("4f62867b-b157-4135-bf47-8dd8ccfa9e50"),
                            CreatedAt = 0L,
                            Name = "Hobs"
                        },
                        new
                        {
                            Id = new Guid("f8eb5864-df81-42f9-b1e5-59848b48c4de"),
                            CreatedAt = 0L,
                            Name = "Cookware"
                        },
                        new
                        {
                            Id = new Guid("b05162a6-e1fe-4116-a9d9-9d78a9871f3a"),
                            CreatedAt = 0L,
                            Name = "Cooker"
                        });
                });
